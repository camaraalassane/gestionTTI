    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="d-flex align-center">
                ...
                <div>
                    <div
                        class="text-caption text-teal-darken-1 font-weight-bold"
                    >
                        GESTION DES STOCKS
                    </div>
                    <span
                        class="font-weight-black text-h6 text-teal-darken-4 text-uppercase"
                    >
        ...
        <v-container
            fluid
            class="pa-6 bg-teal-lighten-5 fill-height align-start"
        >
                ...
                <v-col cols="12" md="10" lg="8">
                    <form @submit.prevent="submit">
                        <v-card
                            border
                            flat
                            class="rounded-xl mb-6 pa-6 shadow-sm bg-white"
                        >
                            <v-card-title
                                class="text-teal-darken-4 font-weight-bold px-0 mb-6 d-flex align-center"
                            >
                                <v-icon start color="teal-darken-1" class="mr-3"
                            ...
                            <v-row>
                                ...
                                <v-col cols="12">
                                    <v-textarea
                                        ...
                                        label="Observations / Détails techniques"
                                        variant="outlined"
                                        color="teal"
                                        density="comfortable"
                                        rows="2"
                        ...
                        >
                            <v-card-title
                                class="text-teal-darken-4 font-weight-bold px-0 d-flex justify-space-between align-center mb-4"
                            >
                                <div class="d-flex align-center">
                                    <v-icon
                                        start
                            ...
                            <v-row
                                ...
                                :key="index"
                                class="align-center mb-4 rounded-lg ma-0 pa-3 border shadow-xs transition-swing"
                                :class="
                                    piece.demande_id
                            ...
                            >
                                <v-col cols="12" md="5" class="py-1">
                                    <v-text-field
                                        v-model="form.pieces[index].nom_piece"
                                        label="Désignation de la pièce"
                                        :readonly="!!piece.demande_id"
                                        :variant="
                                            piece.demande_id
                                                ? 'plain'
                                                : 'solo-filled'
                                ...
                                <v-col cols="12" md="5" class="py-1">
                                    <v-text-field
                                        v-model="
                                            form.pieces[index].numero_serie
                                        "
                                        label="N° de Série"
                                        :readonly="!!piece.demande_id"
                                        :variant="
                                ...
                                >
                                    <v-chip
                                        ...
                                        variant="text"
                                        class="px-0 font-italic font-weight-bold"
                                    >
                            ...
                            <div
                                ...
                                class="text-center py-10 border-dashed rounded-lg bg-grey-lighten-5"
                            >
                                <v-icon color="teal-lighten-3" size="48"
                                    >mdi-package-variant</v-icon
                                >
                                <div
                                    class="text-teal-darken-1 text-caption mt-2 font-weight-bold"
                                >
                        ...
                        <div class="d-flex justify-end gap-4 mt-10">
                            ...
                            <v-btn
                                ...
                                color="teal-darken-3"
                                size="large"
                                class="rounded-lg px-12 elevation-4 font-weight-bold"
