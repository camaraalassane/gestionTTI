            ...
            <v-row align="center" class="mb-8">
                <v-col>
                    <div class="d-flex align-center mb-1">
                        <v-icon class="mr-3" size="32" color="teal-darken-2"
                            >mdi-cog-sync</v-icon
                        >
                        <h1
            ...
            <v-row>
                <v-col cols="12" md="6">
                    <v-card
                        border
                        flat
                        class="rounded-xl shadow-sm bg-white elevation-0"
                    >
                        ...
                        <v-card-item class="pt-4">
                            ...
                            <v-card-title
                                class="text-h6 font-weight-bold text-teal-darken-3"
                            >
                        ...
                        <v-card-text class="pa-6">
                            <v-text-field
                                ...
                                color="teal-darken-2"
                                rounded="lg"
                                :error-messages="formCat.errors.nom"
                            ...
                            <div class="d-flex align-center mb-4">
                                <span
                                    class="text-caption font-weight-black text-uppercase text-teal-darken-1 letter-spacing-1"
                                >
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                <v-chip
                                    ...
                                    variant="flat"
                                    size="large"
                                    class="chip-item white--text font-weight-medium"
                                    closable
                    ...
                    >
                        ...
                        <v-card-text class="pa-6">
                            <v-text-field
                                ...
                                color="teal-darken-2"
                                rounded="lg"
                                :error-messages="formServ.errors.nom"
                                @keyup.enter="submitService"
                                class="mb-2"
                                hide-details="auto"
                            >
                                <template v-slot:append-inner>
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                <v-chip
                                    ...
                                    variant="elevated"
                                    size="large"
                                    class="chip-item border-teal font-weight-medium text-teal-darken-3"
                                    closable
                                    @click:close="deleteService(serv.id)"
                                >
                                    {{ serv.nom }}
                                </v-chip>
                            </div>
