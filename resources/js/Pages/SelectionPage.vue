...
// VÉRIFICATION DE LA PRÉSENCE DU CODE EN BASE (Pour afficher le cadenas ou non)
...
// VÉRIFICATION DU CODE VIA LE SERVEUR (Pour valider la session et passer le middleware)
const verifyAndEnter = () => {
    ...
    router.post(
        ...
        {
            onSuccess: () => {
                // Le contrôleur redirigera automatiquement vers materiel.indexmat
...
<template>
    ...
    <v-app class="portal-app bg-teal-lighten-5">
        <v-main class="d-flex align-center justify-center">
            <v-card
                class="profile-fixed-top ma-4 ma-md-8 pa-2 pr-4 rounded-pill elevation-2"
                color="white"
                style="
                    position: fixed;
                    top: 0;
            ...
            >
                <div class="d-flex align-center">
                    ...
                    <div class="text-left mr-4 d-none d-sm-block">
                        <div
                            class="text-subtitle-2 font-weight-black text-teal-darken-4 leading-none"
                        >
                            {{ userName }}
                        </div>
                        <div
                            class="text-caption text-teal-darken-1 font-weight-bold text-uppercase"
            ...
            <v-container class="py-12">
                <div class="text-center mb-12 mt-10 mt-md-0">
                    ...
                    <h1
                        class="text-h3 text-md-h2 font-weight-black text-teal-darken-4 mb-2"
                    >
                        Espace
                        <span class="text-teal-darken-2">TTI Service</span>
                    </h1>
                ...
                <v-row justify="center" class="px-4">
                    <v-col cols="12" md="5" lg="4">
                        ...
                        >
                            <div class="flex-grow-1">
                                ...
                                <h2
                                    class="text-h5 font-weight-black mb-4 text-uppercase text-teal-darken-4"
                                >
                                    Réception Matériel
                                </h2>
                    ...
                    <v-col cols="12" md="5" lg="4">
                        <v-card
                            @click="router.visit(route('demandes.index'))"
                            elevation="8"
                            class="module-card pa-8 rounded-xl text-center h-100 d-flex flex-column border-t-lg border-teal-darken-2"
                            color="white"
                        >
                            <div class="flex-grow-1">
                                ...
                                <p class="text-grey-darken-1 mb-8 text-body-2">
                                    Suivre les requêtes des services et imprimer
                                    les bons.
                                </p>
                            </div>
                            <v-btn
            ...
            <v-dialog v-model="showCodeModal" max-width="400" persistent>
                <v-card
                    class="rounded-xl pa-6 text-center border-t-lg border-teal-darken-2"
                    color="white"
                >
                    <v-icon
                    ...
                    />
                    <v-card-title
                        class="text-h5 font-weight-black text-teal-darken-4"
                        >Clé d'accès requise</v-card-title
                    >
                    <v-card-text>
                        <p class="text-grey-darken-1 mb-6">
                            Saisissez votre code matériel pour déverrouiller ce
                            module.
                        </p>
                        <v-text-field
                            v-model="inputCode"
            ...
            <v-dialog v-model="showDeniedModal" max-width="450">
                <v-card
                    class="rounded-xl pa-6 text-center border-t-lg border-red-darken-2"
                    color="white"
                >
                    <v-avatar
                        color="red-lighten-5"
                    ...
                    <v-card-title
                        class="text-h5 font-weight-black text-red-darken-4 justify-center"
                        >Accès Interdit</v-card-title
                    >
                    <v-card-text class="text-grey-darken-1 text-body-1">
                        Désolé <strong>{{ userName }}</strong
                        >, vous ne disposez pas d'un code d'accès matériel.<br /><br />
...
.module-card {
    border-top-width: 6px !important; /* Même épaisseur que ton login */
