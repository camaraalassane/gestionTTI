        ...
        <v-container fluid class="pa-0">
            <v-row dense class="mb-6">
                <v-col cols="12" sm="4" class="v-col-custom-5">
                    <v-card
                        flat
                        class="rounded-xl pa-4 bg-teal-darken-1 text-white h-100 position-relative elevation-2"
                    >
                ...
                <v-col cols="6" sm="4" class="v-col-custom-5">
                    <v-card
                        flat
                        class="rounded-xl pa-4 bg-white border-success-left h-100 elevation-1"
                    >
                ...
                <v-col cols="6" sm="4" class="v-col-custom-5">
                    <v-card
                        flat
                        class="rounded-xl pa-4 bg-white border-orange-left h-100 elevation-1"
                    >
                        <div
                ...
                <v-col cols="6" sm="6" class="v-col-custom-5">
                    <v-card
                        flat
                        class="rounded-xl pa-4 bg-white border-teal-left h-100 elevation-1"
                    >
                        <div
                            class="text-caption font-weight-bold text-teal-darken-1"
                        >
                            LIVRÉS (AFFECTÉS)
                        </div>
                        <div class="text-h5 font-weight-black">
                ...
                <v-col cols="6" sm="6" class="v-col-custom-5">
                    <v-card
                        flat
                        class="rounded-xl pa-4 bg-white border-red-left h-100 elevation-1"
                    >
            ...
            <v-row>
                <v-col cols="12" lg="9">
                    <v-card flat class="rounded-xl overflow-hidden elevation-1">
                        <v-card-title class="pa-4 d-flex align-center bg-white">
                            <span
                                class="text-subtitle-2 font-weight-black text-grey-darken-3"
                                >DERNIÈRES RÉCEPTIONS</span
                            >
                            <v-spacer></v-spacer>
                            <v-btn
                                :component="Link"
                                :href="route('materiel.indexmat')"
                                size="small"
                                variant="tonal"
                                color="teal-darken-1"
                        ...
                        >
                            ...
                            <template #[`item.pieces`]="{ item }">
                                <v-chip
                                    size="x-small"
                                    :color="
                                        item.pieces?.some((p) => p.demande_id)
                                            ? 'orange-darken-1'
                                            : 'teal-lighten-4'
                                    "
                                    :class="
                ...
                <v-col cols="12" lg="3">
                    <v-card
                        flat
                        class="rounded-xl pa-5 mb-4 text-center elevation-1 bg-white"
                    >
                        <div class="text-overline mb-2 text-grey-darken-1">
                            Taux d'affectation
                        </div>
                        <v-progress-circular
                            :model-value="tauxOccupation"
                            :size="100"
                            :width="10"
                            color="teal-darken-1"
                        >
                            <span
                                class="text-h6 font-weight-black text-teal-darken-4"
                                >{{ tauxOccupation }}%</span
                            >
                        </v-progress-circular>
                    </v-card>
                    ...
                    <v-card
                        flat
                        class="rounded-xl bg-teal-darken-4 text-white pa-4 elevation-2"
                    >
                        <div
                            class="text-subtitle-2 font-weight-bold mb-4 d-flex align-center"
                        >
                        ...
                        <v-btn
                            ...
                            block
                            color="white"
                            class="text-teal-darken-4 mb-3 text-none font-weight-black rounded-lg"
