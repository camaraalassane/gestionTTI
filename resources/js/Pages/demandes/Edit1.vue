            ...
            <v-card class="mx-auto rounded-lg" max-width="800" border flat>
                ...
                <v-card-text class="pa-6">
                    <v-form @submit.prevent="submit">
                        <v-row>
                            <v-col cols="12" md="6">
                                <v-text-field v-model="form.numcomande" label="N° Commande" variant="outlined" readonly disabled density="comfortable"></v-text-field>
                            </v-col>

                            <v-col cols="12" md="6">
                                <v-text-field v-model="form.demandeur_nom" label="Demandeur" variant="outlined" density="comfortable"></v-text-field>
                            </v-col>

                            <v-col cols="12">
                                <v-autocomplete v-model="form.materiel_id" :items="props.materiels" item-title="nom" item-value="id" label="Matériel" variant="outlined" density="comfortable"></v-autocomplete>
                            </v-col>

                            <v-col cols="12" md="6">
                                <v-autocomplete v-model="form.service_beneficiaire" :items="props.services" item-title="nom" item-value="nom" label="Service Bénéficiaire" variant="outlined" density="comfortable"></v-autocomplete>
                            </v-col>

                            <v-col cols="12" md="6">
                                <v-text-field v-model.number="form.nbredemande" type="number" label="Quantité" variant="outlined" density="comfortable"></v-text-field>
                            </v-col>

                            <v-col cols="12">
                                <v-textarea v-model="form.description" label="Observations" variant="outlined" rows="3"></v-textarea>
                            </v-col>
                        </v-row>
                        ...
                        <div class="d-flex justify-end gap-2">
                            <v-btn variant="text" color="grey-darken-1" @click="retourner" class="mr-2">
                                Annuler
                            </v-btn>
                            <v-btn type="submit" color="teal-darken-2" :loading="form.processing" prepend-icon="mdi-check">
