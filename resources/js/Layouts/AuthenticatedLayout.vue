...
<template>
    <v-app>
            ...
            <v-container class="fill-height d-flex align-center px-4" fluid>
                ...
                <div class="hidden-xs d-sm-flex align-center" style="gap: 12px">
                    <Link :href="route('selection')">
                        <v-btn :active="route().current('selection')" variant="text"
                    ...
                    <Link :href="route('dashboard')">
                        <v-btn :active="route().current('dashboard')" variant="text"
                    ...
                    <Link :href="route('materiel.index')">
                        <v-btn :active="route().current('materiel.index')" variant="text"
                            prepend-icon="mdi-format-list-bulleted" class="text-none custom-nav-btn">
                            Inventaire
                        </v-btn>
                    </Link>

                    <Link :href="route('reception.index')">
                        <v-btn :active="route().current('reception.index')" variant="text"
                            prepend-icon="mdi-file-certificate-outline" class="text-none custom-nav-btn">
                            Contrats
                        </v-btn>
                    </Link>

                    <Link :href="route('materiel.indexmat')">
                        <v-btn variant="flat" color="teal-darken-1" prepend-icon="mdi-plus"
                            class="ml-4 text-none font-weight-black rounded-lg">
                            Nouveau
                        </v-btn>
                    </Link>
                </div>
                    ...
                    <v-list class="pa-2" nav elevation="10">
                        ...
                        <Link :href="route('profile.edit')" class="text-decoration-none">
                            <v-list-item prepend-icon="mdi-account-circle-outline" title="Mon Profil"
                                class="rounded-lg mb-1"></v-list-item>
                        </Link>

                        <Link :href="route('parametres.index')" class="text-decoration-none">
                            <v-list-item prepend-icon="mdi-cog-outline" title="Configuration"
                                class="rounded-lg mb-1"></v-list-item>
                        </Link>
                        ...
                        <Link :href="route('inventaire.index')" class="text-decoration-none">
                            <v-list-item prepend-icon="mdi-archive-check-outline" title="Clôture Annuelle"
                                class="rounded-lg mb-1"></v-list-item>
                        </Link>
                        ...
                        <Link :href="route('logout')" method="post" as="div" class="cursor-pointer">
                            <v-list-item prepend-icon="mdi-logout" title="Déconnexion"
        ...
        <v-navigation-drawer v-model="drawer" temporary width="280">
            ...
            <v-list nav>
                <Link :href="route('selection')">
                    <v-list-item prepend-icon="mdi-view-home" title="Demandes"
                        :active="route().current('selection')"></v-list-item>
                </Link>
                <Link :href="route('dashboard')">
                ...
                <Link :href="route('materiel.index')">
                    <v-list-item prepend-icon="mdi-format-list-bulleted" title="Inventaire"
                        :active="route().current('materiel.index')"></v-list-item>
                </Link>
                <Link :href="route('reception.index')">
                    <v-list-item prepend-icon="mdi-file-certificate" title="Contrats"
                        :active="route().current('reception.index')"></v-list-item>
                </Link>
            </v-list>
        </v-navigation-drawer>
