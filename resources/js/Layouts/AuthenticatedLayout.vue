...
/**
 * ÉTAT & AUTHENTIFICATION (Données intactes)
 */
...
/**
 * GESTION DES NOTIFICATIONS (Style Teal mis à jour)
 */
const snackbar = ref({
    show: false,
    message: "",
                ...
                <div class="hidden-xs d-sm-flex align-center" style="gap: 12px">
                    <Link :href="route('selection')">
                        <v-btn
                            ...
                            variant="text"
                            prepend-icon="mdi-view-home-outline"
                            class="text-none custom-nav-btn"
                        >
                            Demandes
                        </v-btn>
                    </Link>
                    ...
                    <Link :href="route('materiel.index')">
                        <v-btn
                            :active="route().current('materiel.index')"
                            variant="text"
                    ...
                    <Link :href="route('reception.index')">
                        <v-btn
                            :active="route().current('reception.index')"
                            variant="text"
                ...
                >
                    <template v-slot:activator="{ props }">
                        <v-btn
                            icon
                            v-bind="props"
                            class="ml-1 border elevation-1"
                        >
                            <v-avatar color="teal-lighten-5" size="36">
                                <span
                                    class="text-teal-darken-3 font-weight-black text-caption"
                                >
                                    {{ initials }}
                                </span>
                            </v-avatar>
                    ...
                    <v-list class="pa-2" nav elevation="10">
                        <v-list-subheader
                            class="text-uppercase text-caption font-weight-black text-teal"
                        >
                        ...
                        <v-list-subheader
                            class="text-uppercase text-caption font-weight-bold text-teal-darken-2"
                        ...
                        >
                            <v-list-item
                                ...
                                title="Déconnexion"
                                class="rounded-lg text-red-darken-3 font-weight-black"
                            ></v-list-item>
                        </Link>
                    </v-list>
                </v-menu>
