...
// --- LOGIQUE DES NOTIFICATIONS (Gardée intacte) ---
const snackbar = ref({
    show: false,
    message: "",
    color: "success",
            ...
            <v-container class="fill-height d-flex align-center" fluid>
                ...
                <div class="hidden-sm-and-down d-flex" style="gap: 8px">
                    <Link :href="route('admin.stats.global')">
                        <v-btn
                            :active="route().current('admin.stats.global')"
                    ...
                    <Link :href="route('admin.trash.index')">
                        <v-btn
                            :active="route().current('admin.trash.index')"
                ...
                <Link :href="route('selection')">
                    <v-btn
                        ...
                        class="text-none rounded-lg me-3 hidden-xs"
                    >
                        Quitter Admin
                    </v-btn>
                </Link>
